      ...
      <AnimatePresence>
        {hovering && isTouchDevice() == false && (
          <motion.img
            ...
            className="absolute hidden object-cover ml-10 transform -translate-x-1/2 -translate-y-1/2 border select-none lg:block lg:h-preview lg:max-w-preview hover:cursor-default border-textColor w-image left-1/5 top-1/2"
            src={fileName}
            alt={projectTitle}
          />
        )}
